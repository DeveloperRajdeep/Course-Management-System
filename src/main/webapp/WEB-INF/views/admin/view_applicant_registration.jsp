        ...
        <div class="col-md-12">
         <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Candidate Registation Information</h3>
           ...
           <c:url var="addAction" value="/viewapplicantregister"></c:url>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tr>
                <td></td>
                 <td>${StudentRegistration.enrollment_id}</td>
                <td>${StudentRegistration.s_first_name}</td>
				<td>${StudentRegistration.s_middle_name}</td>
				<td>${StudentRegistration.s_last_name}</td>
                  <td><c:forEach var="DegreeMaster" items="${listdegree}">
			 	<c:if test="${DegreeMaster.degree_id==StudentRegistration.degree_id}">
			 		${DegreeMaster.degree_name}
			 	</c:if>
			 </c:forEach></td>
                  <td><c:forEach var="CourseMaster" items="${listcourse}">
			 	<c:if test="${CourseMaster.course_id==StudentRegistration.course_id}">
			 		${CourseMaster.course_name}
			 	</c:if>
			 </c:forEach> </td>
   
			<td>${StudentRegistration.email_id}</td>
			<td>${StudentRegistration.password}</td>
			<td>${StudentRegistration.contact_number}</td>
			<td>${StudentRegistration.status}</td>
			<td>${StudentRegistration.date_time}</td>
