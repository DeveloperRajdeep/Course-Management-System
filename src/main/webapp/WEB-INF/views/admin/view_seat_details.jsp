...
<head>
  ...
  <title>Seat Master Details</title>
        ...
        <div class="col-md-12">
         <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Seat Master Details</h3>
           ...
           <c:url var="addAction" value="/viewSeatdetails"></c:url>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                <c:forEach items="${listSeatDetails}" var="SeatDetail">
                <tr>
                <td></td>
                  <td><c:forEach var="DegreeMaster" items="${listdegree}">
			 	<c:if test="${DegreeMaster.degree_id==SeatDetail.degree_id}">
			 		${DegreeMaster.degree_name}
			 	</c:if>
			 </c:forEach></td>
                  <td><c:forEach var="CourseMaster" items="${listcourse}">
			 	<c:if test="${CourseMaster.course_id==SeatDetail.course_id}">
			 		${CourseMaster.course_name}
			 	</c:if>
			 </c:forEach>
                  </td>
                <td><c:forEach var="BranchMaster" items="${listbranch}">
			 	<c:if test="${BranchMaster.branch_id==SeatDetail.branch_id}">
			 		${BranchMaster.branch_name}
			 	</c:if>
			 </c:forEach></td>
			<td><c:forEach var="CategoryMaster" items="${listCategory}">
			 	<c:if test="${CategoryMaster.category_id==SeatDetail.category_id}">
			 		${CategoryMaster.category_name}
			 	</c:if>
			 </c:forEach></td>
			<td>${SeatDetail.session_s}</td>
			<td>${SeatDetail.total_seats}</td>
			<td>${SeatDetail.seats_alloted}</td>
			<td>${SeatDetail.quota}</td>
			<td>${SeatDetail.status}</td>
			<td>${SeatDetail.date_time}</td>
                  <td><a  class="btn btn-info btn-sm"  href="#" ><i class="fa fa-pencil fa-fw"></i></a></td>
