...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <h3 class="box-title">Add Branch Information</h3>
        </div>
        <c:url var="addAction" value="adddmaster2"></c:url>
		<form:form role="form" action="${addAction}" modelAttribute="BranchMaste" commandName="BranchMaste">
    <div class="box-body">
     <div class="col-lg-12">
            <div class="row">
                  ...
                  <div class="input-group-addon">
                    ...
                    <div class="col-md-6">                  
                        <div class="form-group">
                            ...
                            <form:input path="branch_name" class="form-control" placeholder="Branch Name"/>
                        </div>
                        </div>
                    </div>
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <form:input path="branch_code" class="form-control" placeholder="Branch Code"/>
                        </div>
                    </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <form:select path="branch_status" class="form-control select2" style="width: 100%;" data-placeholder="Select ROle">  
