...
<head>
  ...
  <title>Course Master Details</title>
        ...
        <div class="col-md-12">
         <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Course Master Details</h3>
           ...
           <c:url var="addAction" value="/viewCoursemaster"></c:url>
			<c:url var="addAction" value="adddmaster1"></c:url>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                <c:forEach items="${listCourseMaster}" var="CourseMaste">
                <tr>
                <td></td>
                  <td><c:forEach items="${listdegree }" var="degree" >
			 	<c:if test="${degree.degree_id==CourseMaste.degree_id}">
			 		${degree.degree_name}
			 	</c:if>
			 </c:forEach></td>
                 
                <td>${CourseMaste.course_name}</td>
			<td>${CourseMaste.course_code}</td>
			<td>${CourseMaste.course_status}</td>
			<td>${CourseMaste.date_time}</td>
                  <td><a id="idd" href="<c:url value='/viewCoursemaster/${CourseMaste.course_id}'/>" class="btn btn-info btn-sm"  ><i class="fa fa-pencil fa-fw"></i></a></td>
    ...
    <div class="modal-content">
      <div class="modal-header">
       <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        ...
        <h2 class="modal-title" id="exampleModalLabel">Update Course Details</h2>
      </div>
      <div class="modal-body">
        <c:url var="addAction" value="/admin/Edit1"></c:url> 
  <form:form id="ins" role="form"  action="${addAction}" modelAttribute="course" commandName="list_crse" >
    <div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
        
        <form:input id="modal-id-input" path="course_id" class="form-control" type="hidden" placeholder="Name"/>
                ...
                <div class="col-md-6">
					...
					<form:option value="${DegreeMaster.degree_id}">${DegreeMaster.degree_name}</form:option>
                        ...
                        <div class="form-group">
                            ...
                            <form:input  path="course_name" class="form-control" placeholder="Course Name"/>
                        </div>
                   </div>
                            <div class="col-md-6">
                        <div class="form-group">
                             <label>Course Code</label>    
                            <form:input path="course_code" class="form-control" placeholder="User Name"/>
                        </div>
                    </div>
                      <div class="col-md-6">
                        <div class="form-group">
                             <label>Course Status</label>    
                            <form:input path="course_status" class="form-control" placeholder="User Name"/>
                        </div>
                    </div>
                     <div class="col-md-6">
                        <div class="form-group">
