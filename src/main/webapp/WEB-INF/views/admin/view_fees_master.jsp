...
<head>
  ...
  <title>Fees Master Details</title>
        ...
        <div class="col-md-12">
         <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Fees Master Details</h3>
            ...
            <c:url var="addAction" value="/viewFeesmaster"></c:url>
			<c:url var="addAction" value="addfees"></c:url>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                 <c:forEach items="${listfees}" var="FeesMaster">
                <tr>
                <td></td>
                  <td> <c:forEach var="CourseMaster" items="${listcourse}">
			 	<c:if test="${CourseMaster.course_id==FeesMaster.course_id}">
			 		${CourseMaster.course_name}
			 	</c:if>
			 </c:forEach>
                  </td>
                <td>${FeesMaster.fee_amount}</td>
				<td>${FeesMaster.fee_type}</td>
			<td>${FeesMaster.session}</td>
			<td>${FeesMaster.fee_status}</td>
			<td>${FeesMaster.date_time}</td>
                  <td><a id="idd" href="<c:url value='/viewFeesmaster/${FeesMaster.fee_id}'/>" class="btn btn-info btn-sm"><i class="fa fa-pencil fa-fw"></i></a></td>
    ...
    <div class="modal-content">
      <div class="modal-header">
       <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        ...
        <h2 class="modal-title" id="exampleModalLabel">Update Fee Registration Details</h2>
      </div>
      <div class="modal-body">
        <c:url var="addAction" value="/admin/Edit9"></c:url> 
  <form:form id="ins" role="form"  action="${addAction}" modelAttribute="fees" commandName="list_fee" >
    <div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
        
        <form:input id="modal-id-input" path="fee_id" class="form-control" type="hidden" placeholder="Name"/>
                        ...
                        <div class="form-group">
                            ...
                            <form:input  path="fee_amount" class="form-control" placeholder="Fee Amount"/>
                        </div>
                   </div>
                            <div class="col-md-6">
                        <div class="form-group">
                             <label>Fee Type</label>    
                            <form:input path="fee_type" class="form-control" placeholder="User Name"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                             <label>Session</label>    
                            <form:input path="session" class="form-control" placeholder="User Name"/>
                        </div>
                    </div>
                      <div class="col-md-6">
                <div class="form-group">
                    ...
                    <i class="fa fa-bars" aria-hidden="true"></i>
                     ...
                     <form:select path="fee_status" class="form-control select2" style="width: 100%;" data-placeholder="Select ROle">  
