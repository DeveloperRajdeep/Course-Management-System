...
<head>
  ...
  <title>Branch Master Details</title>
        ...
        <div class="col-md-12">
         <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Branch Master Details</h3>
            ...
            <c:url var="addAction" value="/viewBranchmaster"></c:url>
			<c:url var="addAction" value="adddmaster2"></c:url>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                 <c:forEach items="${listBranchMaster}" var="BranchMaster">
                <tr>
                <td></td>
                  <td> <c:forEach var="DegreeMaster" items="${listdegree}">
			 	<c:if test="${DegreeMaster.degree_id==BranchMaster.degree_id}">
			 		${DegreeMaster.degree_name}
			 	</c:if>
			 </c:forEach></td>
                  <td> <c:forEach var="CourseMaster" items="${listcourse}">
			 	<c:if test="${CourseMaster.course_id==BranchMaster.course_id}">
			 		${CourseMaster.course_name}
			 	</c:if>
			 </c:forEach>
                  </td>
                <td>${BranchMaster.branch_name}</td>
			<td>${BranchMaster.branch_code}</td>
			<td>${BranchMaster.branch_status}</td>
			<td>${BranchMaster.date_time}</td>
                  <td><a id="idd" href="<c:url value='/viewBranchmaster/${BranchMaster.branch_id}'/>" class="btn btn-info btn-sm"><i class="fa fa-pencil fa-fw"></i></a></td>
    ...
    <div class="modal-content">
      <div class="modal-header">
       <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        ...
        <h2 class="modal-title" id="exampleModalLabel">Update Branch Details</h2>
      </div>
      <div class="modal-body">
        <c:url var="addAction" value="/admin/Edit2"></c:url> 
  <form:form id="ins" role="form"  action="${addAction}" modelAttribute="branch" commandName="list_brch" >
    <div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
        
        <form:input id="modal-id-input" path="branch_id" class="form-control" type="hidden" placeholder="Name"/>
                ...
                <div class="col-md-6">
					...
					<form:option value="${DegreeMaster.degree_id}">${DegreeMaster.degree_name}</form:option>
                        ...
                        <div class="form-group">
                            ...
                            <form:input  path="branch_name" class="form-control" placeholder="Course Name"/>
                        </div>
                   </div>
                            <div class="col-md-6">
                        <div class="form-group">
                             <label>Branch Code</label>    
                            <form:input path="branch_code" class="form-control" placeholder="User Name"/>
                        </div>
                    </div>
                      <div class="col-md-6">
                        <div class="form-group">
                             <label>Branch Status</label>    
                            <form:input path="branch_status" class="form-control" placeholder="User Name"/>
                        </div>
                    </div>
                     <div class="col-md-6">
                        <div class="form-group">
