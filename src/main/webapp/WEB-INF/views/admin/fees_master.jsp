...
<!-- Bootstrap 3.3.6 -->
  ...
  <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/plugins/tilmepicker/bootstrap-timepicker.min.css">
  <!-- Select2 -->
...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <h3 class="box-title">Add Registration Fees</h3>
        </div>
        <c:url var="addAction" value="addfees"></c:url>
		<form:form role="form" action="${addAction}" modelAttribute="FeesMaste" commandName="FeesMaste">
    <div class="box-body">
     <div class="col-lg-12">
            <div class="row">              
               	 <div class="col-md-6">
                    ...
                    <div class="col-md-6">                  
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <form:input path="fee_type" class="form-control" placeholder="Fee Type"/>
                        </div>
                    </div>
                    </div>
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <form:input path="session" class="form-control" placeholder="Session"/>
                        </div>
                    </div>
                    </div>
