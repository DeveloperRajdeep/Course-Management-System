...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <h3 class="box-title">Add Degree Information</h3>
        </div>
        <c:url var="addAction" value="adddmaster"></c:url>

	<form:form role="form" action="${addAction}" modelAttribute="DegreeMaste" commandName="DegreeMaste">
    <div class="box-body">
     <div class="col-lg-12">
            <div class="row">
                    ...
                    <div class="col-md-6">                  
                        <div class="form-group">
                            ...
                            <form:input path="degree_name" class="form-control" placeholder="Degree Name" required="required"/>
                        </div>
                        </div>
                    </div>
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <form:input path="degree_code" class="form-control" placeholder="Degree Code" required="required"/>
                        </div>
                    </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <i class="fa fa-bars" aria-hidden="true"></i>
                     ...
                     <form:select path="degree_status" class="form-control select2" style="width: 100%;" data-placeholder="Select ROle">  
...
function CopyAdd() {
  ...
  var a1 = document.getElementById('pa');
  var al1 = document.getElementById('ca');
	
  var a2 = document.getElementById('st');
  var al2 = document.getElementById('st1');
	
  var a3 = document.getElementById('dt');
  var al3 = document.getElementById('dt1');
	
  var v1 = document.getElementById('ct');
  var vl1 = document.getElementById('ct1');
	
  var t1 = document.getElementById('stb');
  var tl1 = document.getElementById('stb1');
	
  var c1 = document.getElementById('po');
  var cl1 = document.getElementById('po1');
	
  var d1 = document.getElementById('ps');
  var dl1 = document.getElementById('pss');
    
  var ca =document.getElementById('pi');
  var ca1 = document.getElementById('pii');    
