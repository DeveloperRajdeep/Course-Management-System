...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <h3 class="box-title">Add Course Information</h3>
        </div>
        <c:url var="addAction" value="adddmaster1"></c:url>
		<form:form role="form" action="${addAction}" modelAttribute="CourseMaste" commandName="CourseMaste">
    	<div class="box-body">
     		<div class="col-lg-12">
            	<div class="row">
                  ...
                  <div class="input-group-addon">
                    ...
                    <div class="col-md-6">                  
                        <div class="form-group">
                            ...
                            <form:input path="course_name" class="form-control" placeholder="Course Name" required="required" />
                        </div>
                        </div>
                    </div>
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <form:input path="course_code" class="form-control" placeholder="Course Code" required="required"/>
                        </div>
                    </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <i class="fa fa-bars" aria-hidden="true"></i>
                     ...
                     <form:select path="course_status" class="form-control select2" style="width: 100%;" data-placeholder="Select ROle">  
