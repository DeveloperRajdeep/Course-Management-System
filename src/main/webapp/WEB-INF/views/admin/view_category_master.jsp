...
<head>
  ...
  <title>Category Master Details</title>
        ...
        <div class="col-md-12">
         <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Category Master Details</h3>
           ...
           <c:url var="addAction" value="/viewCategorymaster"></c:url>
			<c:url var="addAction" value="addmaster3"></c:url>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                 <c:forEach items="${listCategoryMaster}" var="CategoryMaste"> 
                <tr>
                <td></td>
                <td>${CategoryMaste.category_name}</td>
			<td>${CategoryMaste.category_abbr}</td>
			<td>${CategoryMaste.category_status}</td>
			<td>${CategoryMaste.management_quota}</td>
			<td>${CategoryMaste.date_time}</td>
                  <td><a id="idd" href="<c:url value='/viewCategorymaster/${CategoryMaste.category_id}'/>" class="btn btn-info btn-sm" ><i class="fa fa-pencil fa-fw"></i></a></td>
                   <td><a class="btn btn-danger btn-sm" ><i class="fa fa-trash-o fa-fw"></i></a></td>
                </tr>
                </c:forEach> 
                </tbody>
    ...
    <div class="modal-content">
      <div class="modal-header">
       <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        ...
        <h2 class="modal-title" id="exampleModalLabel">Update Category Details</h2>
      </div>
      <div class="modal-body">
        <c:url var="addAction" value="/admin/Edit3"></c:url> 
  <form:form id="ins" role="form"  action="${addAction}" modelAttribute="category" commandName="list_catgry" >
    <div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
        
        <form:input id="modal-id-input" path="category_id" class="form-control" type="hidden" placeholder="Name"/>
                       
   
                <div class="col-md-6">
                        <div class="form-group">
                            <label>Category Name</label>
                            <form:input path="category_name" class="form-control" placeholder="Name"/>
                        </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <form:input  path="category_abbr" class="form-control" placeholder="Passowrd"/>
                        </div>
                   </div>
                            <div class="col-md-6">
                        <div class="form-group">
                             <label>Status</label>    
                            <form:input path="category_status" class="form-control" placeholder="User Name"/>
                        </div>
                    </div>
                     <div class="col-md-6">
                        <div class="form-group">
                             <label>Management Quota</label>    
                            <form:input path="management_quota" class="form-control" placeholder="User Name"/>
                        </div>
                    </div>
                     <div class="col-md-6">
                        <div class="form-group">
