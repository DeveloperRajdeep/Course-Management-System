...
<head>
  ...
  <title>Cut Off Percentage</title>
        ...
        <div class="col-md-12">
         <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Cut Off Percentage Details</h3>
           ...
           <c:url var="addAction" value="/viewCutoffpercentage"></c:url>
			<c:url var="addAction" value="addmaster4"></c:url>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                 <c:forEach items="${listCutOffPercentage}" var="CoPer">
                <tr>
                <td></td>
                  <td>  <c:forEach var="CourseMaster" items="${listcourse}">
			 	<c:if test="${CourseMaster.course_id==CoPer.course_id}">
			 		${CourseMaster.course_name}
			 	</c:if>
			 </c:forEach></td>
                  <td>  <c:forEach var="CategoryMaster" items="${listcategory}">
			 	<c:if test="${CategoryMaster.category_id==CoPer.category_id}">
			 ...
			 <td>${CoPer.marks}</td>
			<td>${CoPer.status}</td>
			<td>${CoPer.created_by}</td>
			<td>${CoPer.date_time}</td>
