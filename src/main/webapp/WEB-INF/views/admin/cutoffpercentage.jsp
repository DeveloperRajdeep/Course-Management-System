...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <h3 class="box-title">Add Cut Off Percentage</h3>
        </div>
       <c:url var="addAction" value="addmaster4"></c:url>
		<form:form role="form" action="${addAction}" modelAttribute="CoPer" commandName="CoPer">
    <div class="box-body">
     <div class="col-lg-12">
            <div class="row">
                  ...
                  <div class="input-group-addon">
                    ...
                    <div class="col-md-6">                  
                        <div class="form-group">
                            ...
                            <form:input path="marks" class="form-control" placeholder="Cut Off Marks" required="required" />
                        </div>
                        </div>
                    </div>
                     <div class="col-md-6">                  
                        <div class="form-group">
                            ...
                            <form:input path="session" class="form-control" placeholder="Current Year" required="required"/>
                        </div>
                        </div>
                    </div>
