...
<div class="box box-success">
    <div class="box-header with-border">
		...
		<form:form role="form" action="${addAction}" modelAttribute="CategoryMaste" commandName="CategoryMaste">
    <div class="box-body">
     <div class="col-lg-12">
            <div class="row">
                    ...
                    <div class="col-md-6">                  
                        <div class="form-group">
                            ...
                            <form:input path="category_name"  class="form-control" placeholder="Category Name" required="required"/>
                        </div>
                        </div>
                    </div>
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <form:input path="category_abbr"  class="form-control" placeholder="Category Abbreviation" required="required"/>
                        </div>
                    </div>
                    </div>
					<div class="col-md-6">
                <div class="form-group">
                    ...
                    <form:select path="category_status" class="form-control select2" style="width: 100%;" data-placeholder="Select ROle" required="required">  
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <form:input path="management_quota" class="form-control" placeholder="Management Quota" required="required"/>
                        </div>
                    </div>
                    </div>
             			 <div class="col-md-6">
